...
description: Use when writing or reviewing GetSuperpower workflow skill files, entry skills, local role skills, step instructions, approval gates, handoffs, or Superpowers/Matt Pocock dependency choices.
---
...
Use this skill to write the `SKILL.md` files inside a GetSuperpower workflow.
...
1. Say it is the entry skill for the GetSuperpower workflow.
