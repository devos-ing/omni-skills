...
install. It requires the `omniskills` CLI on `PATH` or a `GETSUPERPOWER_BIN`
...
```bash
npx omniskills@latest install 'https://github.com/0xroylee/getsuperpower.git#examples/workflows/support-triage'
```
